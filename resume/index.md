---
title: "Resume"
subtitle: "Gameplay Engineer, Technical Artist"
description: "Experienced in game development with a focus on Unity and Godot, specializing in UI design, visual effects, and scripting."
---
...
Pittsburgh, Pennsylvania | [Portfolio: {{SITE}}]({{SITE}}) | [{{EMAIL}}](mailto:{{EMAIL}}) | [{{PHONE}}]({{PHONE_URL}}) | [GitHub: {{GITHUB}}]({{GITHUB}}) | [LinkedIn: {{LINKEDIN}}]({{LINKEDIN}})
...
_George Mason University - Fairfax, VA
August 2016 – June 2022_
...
- **Languages**
  ...
  - **Scripting Languages**: Lua, Python, Bash, Powershell, Regex
- **Frameworks**
